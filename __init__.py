...
def insistType(obj: Any, type_: type) -> Any:
  """Raises an error if obj is not an instance of type and not None.
  >>> insistType(['list', 'of', 'items'], list)
  ['list', 'of', 'items']
  >>> insistType(['list', 'of', 'items'], str)
  Traceback (most recent call last):
    ...
  TypeError: Incorrect type detected!
  """
  if not isinstance(obj, type_):
    raise TypeError('Incorrect type detected!')
  return obj
